    ...
    <main className="rounded-md   text-gray-300 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full  py-8 text-start">
        ...
        <p className="text-gray-400 leading-relaxed text-xs md:text-sm ">
          Full Stack & Web3 Developer crafting dApps, DeFi platforms, and
          immersive Metaverse solutions. I bridge secure blockchain smart
          contracts with intuitive frontends for real-world impact.
        </p>
